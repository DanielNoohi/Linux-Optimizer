...
#### Then:
```
wget "https://raw.githubusercontent.com/DanielNoohi/Linux-Optimizer/blob/main/linux-optimizer.sh" -O linux-optimizer.sh && chmod +x linux-optimizer.sh && bash linux-optimizer.sh 
```
